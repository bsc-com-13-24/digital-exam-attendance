...
exports.RoomsModule = RoomsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([rooms_entity_1.Room, session_students_entity_1.SessionStudent, attendance_records_entity_1.AttendanceRecord]),
            auth_module_1.AuthModule,
        ],
        providers: [rooms_service_1.RoomsService, roles_guard_1.RolesGuard],
