...
export declare class SessionService {
    ...
    constructor(sessionRepository: Repository<Session>, sessionStudentRepository: Repository<SessionStudent>, roomsService: RoomsService);
    createSession(dto: CreateSessionDto, userId: string): Promise<Session>;
